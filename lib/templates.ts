...
# Documentation:
# @raycast.author Command Critic
# @raycast.authorURL https://github.com/command-critic

# Generated by Command Critic
...
`;
  ...
  sequence.forEach((aliasId, index) => {
    ...
    script += `open "raycast://extensions/command-critic/launcher?alias=${aliasId}"\n`;
